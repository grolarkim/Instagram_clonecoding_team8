...
| NO. | 기능                | 설명                                                  |
|-----|---------------------|-------------------------------------------------------|
| 1   | 로그아웃            | 로그인 정보가 담긴 쿠키를 제거하여 로그아웃           |
| 2   | 엔터키 로그인       | 로그인 정보 입력 중 엔터키를 치면 로그인              |
| 3   | 프로필 수정 창      | jquery를 통해 프로필 수정 창 열고 닫기                |
| 4   | 포스트 삭제 수정 창 | jquery를 통해 모달 창 열고 닫기, html에 overflow 제어 |
